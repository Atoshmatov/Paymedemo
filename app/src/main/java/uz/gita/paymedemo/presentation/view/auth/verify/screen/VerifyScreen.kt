package uz.gita.paymedemo.presentation.view.auth.verify.screen
...
class VerifyScreen:Fragment(R.layout.screen_verify) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) = with(binding) {
        ...
        binding.keyboard2.btClear.setOnLongClickListener {
            if (code.isEmpty()) return@setOnLongClickListener true
            code.clear()
            return@setOnLongClickListener true
        }
        binding.keyboard2.btConfirm.setOnClickListener {
